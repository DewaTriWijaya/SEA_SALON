...
class AdapterServices(private val items: List<DataServices>) : RecyclerView.Adapter<AdapterServices.AdapterServiceViewHolder>() {

    inner class AdapterServiceViewHolder(private val binding: ItemCardServiceBinding) : RecyclerView.ViewHolder(binding.root){
        fun bind(item: DataServices) {
            ...
            binding.cardService.setOnClickListener {
                val intent = Intent(itemView.context, DetailReservationActivity::class.java).apply {
